...
<div>
	<div class="shopcart">	
      ...
      <div class="ball-container">
       <transition name="drop" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:after-enter="afterEnter" v-for="(ball,index) in balls" :key="ball.index">
       ...
       // console.log(el);
        for (let i = 0; i < this.balls.length; i++) {
           ...
           if (!ball.show) {
            ...
            // console.log(ball.show === this.balls[i].show);
            return;
           }
        }
      },
